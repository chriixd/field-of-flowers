    ...
    const quests = [
      ...
      },
      {
        ...
        "exp": 75,
        "coins": 75,
        "progress": [{code:"plug in baby",task:"qual è il nome del brano ?"},{code:"californication",task:"qual è il nome del brano ?"},{code:"sextape",task:"qual è il nome del brano ?"}],
        "unlock_npc": 2
      },
      {
